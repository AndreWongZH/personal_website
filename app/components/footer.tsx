...
export default function Footer() {
    return (
        <footer className="flex flex-col items-center justify-center p-10 m-10 gap-5 min-h-[60vh] hide">
            <div className="flex flex-row gap-3">
                <IoShareSocialSharp className="text-highlight" size={40} />
                <h2 className="text-4xl font-bold text-slate-300" >Reach out to me</h2>
            </div>
            ...
            <div className="flex flex-row items-center gap-5">
                <Link
                    ...
                    target="_blank"
                >
                    <FiLinkedin size={50} className="hover:text-highlight" />
                </Link>
                <Link
                    href="https://github.com/AndreWongZH/"
                    target="_blank"
                >
                    <FiGithub size={50} className="hover:text-highlight" />
                </Link>
                <Link
                    href="https://hashnode.com/@andrewong"
                    target="_blank"
                >
                    <SiHashnode size={50} className="hover:text-highlight" />
                </Link>
            </div>
        </footer>
    )
